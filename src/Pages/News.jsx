...
import Ins17 from "../assets/images/insp16.jpg";
  ...
  const news = {
      ...
      DKVACT_9_KONTINÜ_Jangan_Dilewati_Pameran_Tahunan_oleh_Mahasiswa_DKV_ISI_Surakarta:
        {
          ...
          images: {
            img: Ins17,
            caption:
              "Beberapa hasil karya yang dipamerkan di exhibition DKVACT, Sabtu (09/12) malam, Ndalem Joyokusuman, Mangkubumen, Surakarta",
          },
    ...
    politics: {
      ...
      RAPAT_ANGGOTA_HIMAKOM_UNS_XXVIII_20232024_HARI_KEDUA: {
        id: "RAPAT_ANGGOTA_HIMAKOM_UNS_XXVIII_20232024_HARI_KEDUA",
        ...
        images: {
          img: Ins15,
          caption:
            "Foto bersama pengurus BEM FISIP UNS Kabinet Satya Jaghana Citra dalam kegiatan Catatan Akhir Tahun BEM FISIP UNS 2023 pada Minggu (10/12/2023).",
        },
    ...
    inspirations: {
      ...
      Kajian_Ustadz_Hanan_Attaki_Melawan_Ketidakpastian: {
        ...
        images: {
          img: Ins13,
          caption:
            "Setiap manusia pasti pernah merasakan ketidakpastian dalam hidupnya",
        },
      ...
      HEROES_KEHANGATAN_DAN_SUKACITA_NATAL_PMK_FISIP_UNS_2023: {
        ...
        images: {
          img: Ins14,
          caption:
            "Penyembahan dalam kegiatan acara natal PMK FISIP UNS Surakarta, Jawa Tengah, Kamis (08/12/2023).",
        },
        release: "Kamis, 08 Desember 2023",
        category: "Inspirations",
        author: "Efraim Nicholas Hutapea",
      ...
      Sudah_Berstatus_Demisioner_BEM_FISIP_UNS_Adakan_Kegiatan_Terakhir_Bersama:
        {
          ...
          images: {
            img: Ins16,
            caption:
              "Foto bersama pengurus BEM FISIP UNS Kabinet Satya Jaghana Citra dalam kegiatan Catatan Akhir Tahun BEM FISIP UNS 2023 pada Minggu (10/12/2023).Foto bersama pengurus BEM FISIP UNS Kabinet Satya Jaghana Citra dalam kegiatan Catatan Akhir Tahun BEM FISIP UNS 2023 pada Minggu (10/12/2023).",
          },
          release: "Minggu, 10 Desember 2023",
          category: "Inspirations",
          author: " Alvina Rahma Khalishafitri",
