    ...
    textInput: {
      field: {
        ...
        input: {
          ...
          colors: {
            gray: "bg-gray-50 text-gray-900 focus:border-blue-400 focus:ring-[2px] focus:ring-blue-300 dark:border-gray-600 dark:placeholder-gray-400 dark:focus:border-red-500 dark:focus:ring-red-50",
          },
        },
      },
    },
